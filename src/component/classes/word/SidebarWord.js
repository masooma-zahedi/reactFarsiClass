    ...
    <div className=' mt-4 f-right shadow-lg' style={{position:'sticky',top:"10px"}}>
      <div className="sidebar border-end">
        ...
        <ul className="sidebar-nav">
          ...
          <li className="nav-item">
            <NavLink className="nav-link text-success h6" to="./sentenceObject">جملات و مترادف ها</NavLink>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <NavLink className="nav-link text-success h6" to="./typingQAImageSlider">تایپ جمله</NavLink>
          </li>
          <li className="nav-item">
