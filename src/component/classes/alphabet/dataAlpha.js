...
export let words2 = ['صابون','اِصرار','صَبر','صَدر','صُحبَت','بَصیرَت','تَصویر','صورَت', ];
...
export let words17 = ["چای","چراغ","چتر","چاقو","چشم","چوب","چمن","چرخ","چکمه","چاه","چیپس","چمدان","چارقد","چسب","چنگال"];
